...
class GlintLanguageServer {
    constructor(ts, glintConfig, documents, transformManager, parsedConfig) {
        this.ts = ts;
    ...
    watchedFileWasAdded(uri) {
        this.rootFileNames.add(this.glintConfig.getSynthesizedScriptPathForTS((0, util_1.uriToFilePath)(uri)));
    }
