...
function performWatch(ts, glintConfig, tsconfigPath, optionsToExtend) {
    ...
    let host = ts.createWatchCompilerHost(tsconfigPath !== null && tsconfigPath !== void 0 ? tsconfigPath : 'tsconfig.json', optionsToExtend, sysForWatchCompilerHost(ts, transformManager), ts.createSemanticDiagnosticsBuilderProgram, (diagnostic) => console.error(formatDiagnostic(diagnostic)));
